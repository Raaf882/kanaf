        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center gap-8">
                    <a href="{{ auth()->check() ? route(match(auth()->user()->role) { 'admin' => 'admin.dashboard', 'advisor' => 'advisor.dashboard', default => 'home' }) : route('login') }}"
                    ...
                    <div class="hidden md:flex items-center gap-6">
                        ...
                        <a href="{{ route('home') }}"
                           class="text-sm font-semibold pb-1 transition-colors
                                  {{ request()->routeIs('home') ? 'text-[#1A6B3C] border-b-2 border-[#1A6B3C]' : 'text-gray-600 hover:text-[#1A6B3C]' }}">
                            {{ __('الرئيسية') }}
                        </a>
                        ...
                        <a href="{{ route('advisor.dashboard') }}"
                           class="text-sm font-semibold pb-1 text-[#1A6B3C] border-b-2 border-[#1A6B3C]">
                            {{ __('لوحة المرشد') }}
                        </a>
